                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="pent_length" name="pent_length" 
                               value="{{ old('pent_length', $pent->pent_length) }}" required>
                        @error('pent_length')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="waist" name="waist" 
                               value="{{ old('waist', $pent->waist) }}" required>
                        @error('waist')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="hips" name="hips" 
                               value="{{ old('hips', $pent->hips) }}" required>
                        @error('hips')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inseam" name="inseam" 
                               value="{{ old('inseam', $pent->inseam) }}" required>
                        @error('inseam')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="pensa" name="pensa" 
                               value="{{ old('pensa', $pent->pensa) }}" required>
                        @error('pensa')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
