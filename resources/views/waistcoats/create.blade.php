...
<div class="container d-flex justify-content-center align-items-center my-5" style="min-height: 80vh;">
    <div class="card shadow-sm w-100" style="max-width: 600px;">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <a href="{{ route('waistcoats.index') }}" class="text-decoration-none" style="font-size: 14px; color: blue;">Show Waistcots Measurements</a>
            </h5>
            <button type="submit" form="waistcoatForm" class="btn btn-primary">
                <i class="bi bi-plus-circle"></i> Add Waistcoat Measurement
            </button>
        </div>
        ...
        <div class="card-body">
            ...
            <form id="waistcoatForm" action="{{ route('waistcoats.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('length') is-invalid @enderror" id="length" name="length"
                            value="{{ old('length') }}" placeholder="Enter length" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('chest') is-invalid @enderror" id="chest" name="chest"
                            value="{{ old('chest') }}" placeholder="Enter chest" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('shoulder') is-invalid @enderror" id="shoulder" name="shoulder"
                            value="{{ old('shoulder') }}" placeholder="Enter shoulder" required>
                    ...
                    <div class="col-md-6">
                        ...
                        @error('pocket_type') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
