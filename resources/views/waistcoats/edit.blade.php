...
<div class="container d-flex justify-content-center align-items-center my-5" style="min-height: 80vh;">
    <div class="card shadow-sm w-100" style="max-width: 600px;">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <a href="{{ route('waistcoats.index') }}" class="text-decoration-none" style="font-size: 14px; color: blue;">Show Waistcoats Measurements</a>
            </h5>
            <button type="submit" form="waistcoatForm" class="btn btn-primary">
                <i class="bi bi-save"></i> Update Waistcoat Measurement
            </button>
        </div>
